...
features = np.loadtxt('features_upto10K_SrCs.txt')
targets = np.loadtxt('targets_upto10K_SrCs.txt')
...
train_the_model = model.fit(features_train, targets_train, batch_size = batch_size, epochs =20000)
model.save_weights('model_SrCs_upto10K')
